...
- **ต้องแปลงข้อมูลทุกบรรทัด ไม่ข้ามบรรทัดใดเลย**
- **แม้ข้อมูลจะไม่ครบถ้วนหรือไม่ชัดเจน ก็ต้องสร้าง record ให้**
- **ห้ามข้ามคนใดคนหนึ่ง แม้ข้อมูลจะไม่ครบ**
- **ถ้าข้อมูลไม่ชัด → ใส่ "" (string ว่าง) แต่ต้องสร้าง record**
- **ถ้าพบชื่อหรือลำดับที่ใหม่ → สร้าง record ใหม่ทันที**
- **ต้องนับจำนวน records ให้ครบตามที่ปรากฏในเอกสาร (ควรมี 50-70 records)**
...
- ถ้าพบชื่อใหม่ → สร้าง record ใหม่ทันที
- **แม้ชื่อจะไม่ชัดเจนหรือไม่สมบูรณ์ ก็ต้องสร้าง record**
...
- Format: { "rows": [ {...}, {...} ] }
- **ต้องมี record ครบทุกบรรทัดที่พบในเอกสาร**
